...
import { CheckCircle2, Heart, Shield, Calendar, Phone } from "lucide-react";
            ...
            >
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Health statistics and heart monitor"
                  width={2000}
                  height={700}
      ...
      <section className="py-28 bg-linear-to-br from-[#066BAA]/6 to-teal-50" style={{fontFamily : "poppins"}}>
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white rounded-3xl   p-18 max-w-6xl mx-auto border border-slate-200"
          >
